...
[bio.terra.gaaibroker.App](./service/src/main/java/bio/terra/gaaibroker/App.java).
...
- [bio.terra.gaaibroker](./service/src/main/java/bio/terra/gaaibroker)
...
- `dao/`: ORM mapping from the configured database to `bio.terra.gaaibroker.model`

...
import bio.terra.gaaibroker.client.ApiClient;
...
public class GaaibrokerClient extends ApiClient {
   ...
   */
  public GaaibrokerClient(ServerSpecification server) throws IOException {
    this(server, null);
  }
   ...
   */
  public GaaibrokerClient(ServerSpecification server, TestUserSpecification testUser)
      throws IOException {

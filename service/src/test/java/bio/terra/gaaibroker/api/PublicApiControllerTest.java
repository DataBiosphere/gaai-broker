...
import bio.terra.gaaibroker.config.VersionConfiguration;
import bio.terra.gaaibroker.controller.PublicApiController;
import bio.terra.gaaibroker.model.SystemStatus;
import bio.terra.gaaibroker.service.StatusService;
...
class PublicApiControllerTest {
  ...
  void testVersion() throws Exception {
    ...
    String github = "https://github.com/DataBiosphere/gaai-broker/tree/0.9.0";
    String build = "0.1.0";
